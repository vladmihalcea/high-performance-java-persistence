package com.vladmihalcea.hpjp.hibernate.inheritance.spring.config;
...
@ComponentScan(basePackages = "com.vladmihalcea.hpjp.hibernate.inheritance.spring")
...
public class BehaviorDrivenInheritanceConfiguration {
    ...
    protected String[] packagesToScan() {
        return new String[]{
                "com.vladmihalcea.hpjp.hibernate.inheritance.spring.model"
        };
    }
}
