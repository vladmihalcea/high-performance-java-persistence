 ...
 */
public class SQLServerDateTimeColumnSizeTest extends AbstractTest {
    ...
    public static class Event {
        ...
        @Column(name = "created_on", columnDefinition = "datetime2(0)")
        private OffsetDateTime createdOn;

        @Column(name = "updated_on", columnDefinition = "datetime2(3)")
        private ZonedDateTime updatedOn;

        @Column(name = "last_accessed_on", columnDefinition = "datetime2(5)")
