 ...
 */
public class OracleTimestampWithLocalZoneOffsetDateTimeTest extends AbstractTest {
    ...
    public static class Book {
        ...
        @Column(name = "published_on", columnDefinition = "TIMESTAMP WITH LOCAL TIME ZONE")
        private OffsetDateTime publishedOn;

        @Column(name = "updated_on", columnDefinition = "TIMESTAMP WITH LOCAL TIME ZONE")
