package com.vladmihalcea.hpjp.spring.transaction.contract.config;

import com.vladmihalcea.hpjp.spring.transaction.contract.event.RootAwareEventListenerIntegrator;
...
@ComponentScan(
    basePackages = {
        "com.vladmihalcea.hpjp.spring.transaction.contract",
    }
)
@EnableJpaRepositories("com.vladmihalcea.hpjp.spring.transaction.contract.repository")
...
public class ContractConfiguration {
    ...
    protected String[] packagesToScan() {
        return new String[]{
            "com.vladmihalcea.hpjp.spring.transaction.contract.domain"
        };
    }
}
