package com.vladmihalcea.hpjp.spring.stateless.mysql.config;
...
@EnableJpaRepositories(
    value = "com.vladmihalcea.hpjp.spring.stateless.mysql.repository",
    repositoryBaseClass = BaseJpaRepositoryImpl.class
)
@ComponentScan(
    value = {
        "com.vladmihalcea.hpjp.spring.stateless.mysql.service",
        "io.hypersistence.utils.spring.aop"
    }
)
public class MySQLSpringStatelessSessionBatchingConfiguration {
    ...
    protected String[] packagesToScan() {
        return new String[]{
            "com.vladmihalcea.hpjp.spring.stateless.mysql.domain"
        };
    }
}
