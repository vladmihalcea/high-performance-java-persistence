...
@ComponentScan(
    basePackages = {
        "com.vladmihalcea.hpjp.spring.transaction.transfer.service",
    }
)
@EnableJpaRepositories("com.vladmihalcea.hpjp.spring.transaction.transfer.repository")
@EnableTransactionManagement
@EnableAspectJAutoProxy
public class ACIDRaceConditionTransferConfiguration {
    ...
    protected String[] packagesToScan() {
        return new String[]{
            "com.vladmihalcea.hpjp.spring.transaction.transfer.domain"
        };
    }
}
