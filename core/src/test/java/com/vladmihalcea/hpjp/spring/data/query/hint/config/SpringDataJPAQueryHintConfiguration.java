package com.vladmihalcea.hpjp.spring.data.query.hint.config;
...
@ComponentScan(
    basePackages = {
        "com.vladmihalcea.hpjp.spring.data.query.hint",
    }
)
...
public class SpringDataJPAQueryHintConfiguration extends SpringDataJPABaseConfiguration {
