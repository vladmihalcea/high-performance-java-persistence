package com.vladmihalcea.book.hpjp.hibernate.transaction.spring.data.config;
...
@ComponentScan(
    basePackages = {
       "com.vladmihalcea.book.hpjp.hibernate.transaction.spring.data.service",
    }
)
@EnableTransactionManagement
@EnableAspectJAutoProxy
@EnableJpaRepositories("com.vladmihalcea.book.hpjp.hibernate.transaction.spring.data.repository")
