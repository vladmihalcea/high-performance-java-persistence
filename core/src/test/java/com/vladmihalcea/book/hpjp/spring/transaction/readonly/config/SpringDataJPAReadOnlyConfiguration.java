package com.vladmihalcea.book.hpjp.spring.transaction.readonly.config;
...
import com.vladmihalcea.book.hpjp.spring.transaction.readonly.config.stats.SpringTransactionStatisticsFactory;
...
@ComponentScan(
    basePackages = {
        "com.vladmihalcea.book.hpjp.spring.transaction.readonly",
    }
)
@EnableJpaRepositories(
    basePackages = {
        "com.vladmihalcea.book.hpjp.spring.transaction.readonly.repository"
    }
)
