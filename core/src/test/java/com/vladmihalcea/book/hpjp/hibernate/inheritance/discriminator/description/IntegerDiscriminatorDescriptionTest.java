    ...
    public void test() {
        ...
        doInJPA(entityManager -> {
            ...
            .createNativeQuery(
                ...
                "ORDER BY t.topic_type_id", Tuple.class)
            .getResultList();
            ...
            Tuple announcementTuple = results.get(1);

            assertTrue(
                announcementTuple.get("validUntil") != null
            );
            assertEquals(
                Announcement.class.getName(),
                announcementTuple.get("type_name")
            );
            assertEquals(
                "Announcement is a subclass of the Topic base class",
                announcementTuple.get("type_description")
            );
