package com.vladmihalcea.book.hpjp.spring.data.query.specification.config;
...
@ComponentScan(
    basePackages = {
        "com.vladmihalcea.book.hpjp.spring.data.query.specification",
    }
)
@EnableJpaRepositories(
    basePackages = "com.vladmihalcea.book.hpjp.spring.data.query.specification.repository",
