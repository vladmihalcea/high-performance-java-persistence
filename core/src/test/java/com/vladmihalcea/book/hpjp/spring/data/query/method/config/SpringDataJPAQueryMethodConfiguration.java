package com.vladmihalcea.book.hpjp.spring.data.query.method.config;
...
@ComponentScan(
    basePackages = {
        "com.vladmihalcea.book.hpjp.spring.data.query.method",
    }
)
@EnableJpaRepositories(
    basePackages = "com.vladmihalcea.book.hpjp.spring.data.query.method.repository",
