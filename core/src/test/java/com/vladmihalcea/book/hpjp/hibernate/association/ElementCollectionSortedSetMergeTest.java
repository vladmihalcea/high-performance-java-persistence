 ...
 */
public class ElementCollectionSortedSetMergeTest extends AbstractTest {
    ...
    @Embeddable
    public static class Comment implements Serializable, Comparable {
    ...
    public static class CommentComparator implements Comparator<ElementCollectionSortedSetMergeTest.Comment> {
        @Override
        public int compare(ElementCollectionSortedSetMergeTest.Comment o1, ElementCollectionSortedSetMergeTest.Comment o2) {
            return 0;
        }
    }
}
