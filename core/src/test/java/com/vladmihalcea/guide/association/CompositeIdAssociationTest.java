...
/**
 * <code>CompositeIdAssociationTest</code> - Composite Id associations Test
 *
 * @author Vlad Mihalcea
 */
public class CompositeIdAssociationTest extends AbstractTest {
    ...
    public void testLifecycle() {
        PersonAddress _personAddress = doInJPA(entityManager -> {
